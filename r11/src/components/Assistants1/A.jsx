...
function A() {
  ...
  const filteredData = data.filter(item =>
    ...
    item.phone1.includes(searchQuery) ||
    item.phone2.includes(searchQuery)
  );
  ...
  return (
    ...
    //     <Container fluid>
    //       <Table hover className="border border-black bg-white">
    //         <thead>
    //           <tr>
    ...
    //               <Pagination className="mb-0 mt-2 ms-3 justify-content-end">
    ...
    //                 <span className="ms-3">Rows per page:</span>
    //                 <Input
    //                   type="select"
    //                   className="ms-2"
    //                   style={{ width: "100px" }}
